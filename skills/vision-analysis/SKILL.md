...
description: >
  Analyze, describe, extract text from images using MiniMax vision MCP.
  Triggers: user shares image file (.jpg/.png/.gif/.webp/.bmp/.svg/.bmp) or URL,
  or uses words like analyze/describe/explain/review/OCR/understand near
  an image, screenshot, diagram, chart, mockup, wireframe, or photo.
license: MIT
metadata:
  version: "1.0"
  category: ai-vision
