...
matrix_table(s, Inches(0.3), Inches(1.2), Inches(12.7), Inches(2.5),
    ['STR档次', '中文', 'ADR区间(¥)', '代表品牌', '五一ADR同比', '五一OCC预测', 'RevPAR预测'],
    [
        ['Luxury', '奢华', '1500+', '安缦·宝格丽·丽思', '+0.4%', '60-75%', '+1~3%'],
        ['Upper Upscale', '高端', '800-1500', '洲际·万豪·希尔顿·凯悦', '+0.4%', '65-78%', '+2~4%'],
        ['Upscale', '中高端', '400-800', '美居·桔子水晶·亚朵', '+2.3%', '75-88%', '+4~7%'],
        ['Upper Midscale', '中端', '250-400', '全季·维也纳·麗枫', '+3.9%', '85-95%', '+6~9%'],
        ['Midscale', '经济中端', '150-250', '汉庭·如家·7天', '+3.6%', '90-98%', '+5~7%'],
        ['Economy', '经济', '100-150', '99旅馆·布丁', '+3.6%', '85-95%', '+4~6%'],
    ])

# ADR recovery comparison chart
vchart(s, Inches(0.3), Inches(4.0), Inches(6.5), Inches(2.8),
    "各档次ADR同比对比：2025五一 vs 2026五一",
    ['奢华','高端','中高端','中端','经济中端','经济'],
    [0.4, 0.4, 2.3, 3.9, 3.6, 3.6],
    [LGRAY, RGBColor(0x66,0x99,0xBB), LBLUE, BLUE, BLUE, BLUE])
...
p.text = "完整复盘：5/12  |  数据日历：DATA-CALENDAR.md  |  18数据源：交通运输部·酒店之家·浩华·中信·同程·携程·迈点·环球旅讯·STR·戴德梁行等"
