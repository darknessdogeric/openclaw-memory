...
ROUTING_TABLE = {
    ...
    "酒店": {"kb": "hotel-industry-knowledge-base", "triggers": ["酒店", "民宿", "收益", "ADR", "OCC", "入住率", "定价", "OTA", "携程", "洲际", "希尔顿"]},
    "AI技术": {"kb": "ai-llm-knowledge-base", "triggers": ["AI", "LLM", "AGENT", "Prompt", "RAG", "大模型", "Kimi", "DeepSeek", "代码", "架构"]},
    "创业融资": {"kb": "startup-fundraising-knowledge-base", "triggers": ["融资", "股权", "YC", "路演", "BP", "VC", "投资", "IPO", "AHL"]},
    "大乐透": {"kb": "lottery-knowledge-base", "triggers": ["大乐透", "彩票", "预测", "开奖", "体彩"]},
    "金融": {"kb": "finance-securities-knowledge-base", "triggers": ["金融", "证券", "投资", "股票", "债券", "REITs"]},
    "跨境": {"kb": "cross-border-trade", "triggers": ["跨境", "选品", "亚马逊", "Amazon", "出海", "外贸", "集装箱"]},
